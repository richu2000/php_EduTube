  ...
  <div class="container">
    <div class="row">
      ...
      <li class="breadcrumb-item">
        ...
        <a href="<?php echo site_url("Allcourses/loadPlaylistInfo/").$playlistID; ?>"> <?php echo $pname[0]->playlistName; ?> </a></li>
      <?php 
    ...
    <div class="cs_instructor">
        <ul class="cs_instrct_list float-left mb0">
                  ...
                  <?php 
                    ...
                    {
                  ?>
                       <a href="<?php echo site_url('Allcourses/otheruser/'.$v->userID);?>">
        ...
        <div class="cs_overview">
          ...
          <?php 
            if(isset($_SESSION['uname']))
            {
              ...
              {
                ?>
                <a href="<?php echo site_url('Allcourses/addLike/'.$playlistID.'/'.$videoID);?>">
              ...
              {
                ?>
             <a href="<?php echo site_url('Allcourses/addUnlike/'.$playlistID.'/'.$videoID);?>">   
            <i class="fa fa-heart" style="color: red"></i></span></a>
                <?php
              }
            }
              ?>  
          <!-- <a href="<?php echo site_url('Allcourses/addUnlike/'.$playlistID.'/'.$videoID);?>"><i class="fa fa-heart" style="color: red"></i></a> -->
          <?php
            echo $countlikes;
          ?> Likes
        </h4>
          ...
          ?>          
          <span class="picture">
            <a href="<?php echo site_url('Allcourses/otheruser/'.$l->userID);?>">
                        <img class="thumb" src="<?php echo base_url('Resources/User video/images/'.$l->userImage)?>" width="18" height="18" alt="4.png" />
                      </a>
            <!-- <img src="<?php echo base_url('Resources/User video/images/'.$l->userImage);?>" class="userpicture" width="18" height="18" /> -->
          </span> 
            <?php
                echo $l->firstName."<br/>";   
              }
  ...
  <button class="tablinks" onclick="openContent(event, 'Questions')">Questions</button>
      ...
      <ul>
        ...
        <div class="comment-message">
          <div class="comment-message-meta mr-3">  
            <span class="picture">
            <a href="<?php echo site_url('Allcourses/otheruser/'.$c->userID);?>">
          ...
          <form method="post" action="<?php echo site_url('Allcourses/removeComment/'.$c->commentID.'/'.$playlistID.'/'.$videoID);?>">
    ...
    <br/>
      <?php
         ...
         {
          ?>
      <form method="post" action="<?php echo site_url('Allcourses/addComment/'.$playlistID.'/'.$videoID);?>">
    ...
    <!-- questions -->
      ...
      <ul>
        ...
        <div class="comment-message">
          <div class="comment-message-meta mr-3">  
            <span class="picture">
              <a href="<?php echo site_url('Allcourses/otheruser/'.$q->userID);?>">
                ...
                foreach ($videoinfo as $v)
                 ...
                 if(isset($_SESSION["uname"]))
                 {
                  ...
                  
                  {
                        ...
                        {
                          ?>
                            <form method="post" action="<?php echo site_url('Allcourses/addAnswer/'.$playlistID.'/'.$videoID.'/'.$q->videoQuestionID);?>">
    ...
    <?php
         ...
         {
          ?>
      <form method="post" action="<?php echo site_url('Allcourses/addQuestions/'.$playlistID.'/'.$videoID);?>">
