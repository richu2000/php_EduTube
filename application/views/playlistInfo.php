...
<button type="submit" class="btn btn-log btn-block btn-thm3" id="addPlaylist" onclick="javascript:addVideo()">Add video</button>

<script type="text/javascript">
  function addVideo()
  {
    window.location.href = "<?php echo site_url("Playlist/loadAddVideo/").$_SESSION['uid'] ."/".$pname[0]->playlistID; ?>";
  }
</script>
                        ...
                        <div class="top_courses list">
                          ...
                          <div class="details">
                            <div class="tc_content">
                              ...
                              <a href="<?php echo site_url("Playlist/loadVideoinfo/").$pname[0]->playlistID ."/" .$v->videoID; ?>"><h5> <?php echo $v->Title; ?> </h5></a><br>
                              <a href="<?php echo site_url("Playlist/removeVideo/").$_SESSION['uid'] ."/". $pname[0]->playlistID ."/" .$v->videoID; ?>"> Delete  video </a>
                            </div>
                          </div>
                        </div>
                      </div>
                  ...
                  <div class="courses row courses_container">
                    <div class="col-lg-12 p0">
                      <div class="courses_list_content">
                        <div class="top_courses list">
                          <span class="picture">
                            <a href="<?php echo site_url('playlist/otheruser/'.$r->userID);?>">
...
<script type="text/javascript">
  function addForum()
  {
    window.location.href = "<?php echo site_url("Playlist/loadAddForum/").$_SESSION['uid']."/".$pname[0]->playlistID; ?>";
  }
  function viewForum(fid)
  {
        window.location.href ="<?php echo site_url("Playlist/loadViewForum/").$_SESSION['uid']."/".$pname[0]->playlistID."/"?>"+fid
  }
<?php } ?>
</script>
     <div class="container">
                        ...
                        <div class="top_courses list">
                          <div class="details">
                            <div class="tc_content">
                              ...
                              <a href="<?php echo site_url('playlist/otheruser/'.$f->userID);?>">
                              <img class="userpicture" src="<?php echo base_url('Resources/User Video/Images/').$f->userImage?>" height=25px width=25px></a>
                              </span>
