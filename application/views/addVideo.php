      ...
      <div class="col-xl-12 text-center">
        <div class="breadcrumb_content">
            ...
            <ol class="breadcrumb">
              ...
              <li class="breadcrumb-item">
                <a href="" aria-current="page"> Add video </a>
              </li>
            </ol>
        </div>
      </div>
			...
			<div class="row">
				<div class="col-sm-12 col-lg-6 offset-lg-3">
					<div class="sign_up_form inner_page">
						...
						<div class="details">
							<form action="<?php echo site_url("Playlist/addVideo/").$_SESSION['uid'] ."/". $pname[0]->playlistID; ?>" method="post" enctype="multipart/form-data">
								<div class="form-group">
							    	<input type="text" class="form-control" name="txtVtitle" placeholder="Video title">
								</div>
								...
								<div class="form-group">
							    	Thumbnail &nbsp;&nbsp;&nbsp; <input type="file" name="img">
								</div>

								Upload video
								<div class="form-group">
							    	<input type="file" class="form-control" name="txtURL" placeholder="upload video">
								</div>
