    <!-- comments -->
    <!-- <div id="inst110" class=" block_comments block " role="complementary" data-block="comments" > -->
       <div class="overflow-auto">
        ...
        <div class="comment-message">
            ...
            <img src="<?php echo base_url('Resources/user video/images/'.$c->userImage);?>" class="userpicture" width="18" height="18" alt="Picture of Krisztina Szer" title="Picture of Krisztina Szer" /></a>
            </span>
            <span class="user">
              <a href=""><?php echo $c->firstName?></a></span>             
...
<section class="inner_page_breadcrumb">
  <div class="container">
    <div class="row">
      ...
      <li class="breadcrumb-item">
        <a href="<?php echo site_url("Allcourses/loadPlaylists/") ?>" aria-current="page">all playlists</a>
      <li class="breadcrumb-item">
    ...
    <div class="courses_big_thumb">
      <div class="thumb">
        <iframe class="iframe_video" src="http://www.youtube.com/<?php echo $v->videoURL?>" frameborder="0" allowfullscreen>
        </iframe>
      </div>
    </div>
    <!-- video url end -->
    ...
    <div id="likes" class=" block_cocoon_course_overview block " role="complementary" data-block="cocoon_course_overview">
      <div class="cs_row_two">
        <div class="cs_overview">
          ...
          ?>          
          <span class="picture"><a href="">
            <img src="<?php echo base_url('Resources/User video/images/'.$l->userImage);?>" class="userpicture" width="18" height="18" /></a>
          </span> 
            <?php
                echo $l->firstName."<br/>";   
              }
      ...
      <ul>
        ...
        <div class="comment-message">
          ...
          <div class="text">
            <div class="no-overflow">
              <div class="text_to_html">
               Question: <?php echo $q->videoQuestionDesc?><br/>
               <?php 
               if($q->Answer!=null)
               {
                ?>
