 		...
 		<div class="row">
          ...
          <div class="box box-primary">
            <div class="box-header with-border">
              <h3 class="box-title">Update city Form</h3>
            </div>
            <form role="form" method="post" action="<?php echo site_url('admin/Country/editcity/'.$cityinfo[0]->cityID.'/'.$cityinfo[0]->stateID);?>">
              <div class="box-body">
                <div class="form-group">
                  <label for="exampleInputEmail1">Enter city Name</label>
                  <input type="text" class="form-control" id="exampleInputEmail1" placeholder="newcity" name="txtcity" value="<?php echo $cityinfo[0]->cityName?>">
                </div>                
              </div>
