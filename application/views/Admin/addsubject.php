    ...
    <div class="row">
      <div class="col-md-12">
          ...
          <div class="box box-primary">
            ...
            <form role="form" method="post" action="<?php echo site_url('admin/Category/addsubject/'.$SubCatID);?>">
              <div class="box-body">
                <div class="form-group">
                  <label for="exampleInputEmail1">Enter subject Name</label>
                  <input type="text" class="form-control" id="exampleInputEmail1" placeholder="new subject" name="txtsubject">
                </div>                
              </div>
