 		...
 		<div class="row">
          ...
          <div class="box box-primary">
            <div class="box-header with-border">
              <h3 class="box-title">Update subject Form</h3>
            </div>
            <form role="form" method="post" action="<?php echo site_url('admin/Category/editsubject/'.$subjectinfo[0]->subjectID.'/'.$subjectinfo[0]->SubCategoryID);?>">
              <div class="box-body">
                <div class="form-group">
                  <label for="exampleInputEmail1">Enter subject Name</label>
                  <input type="text" class="form-control" id="exampleInputEmail1" placeholder="newsubject" name="txtsubject" value="<?php echo $subjectinfo[0]->subjectName?>">
                </div>                
              </div>
