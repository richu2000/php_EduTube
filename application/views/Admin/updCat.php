    ...
    <section class="content">
 		<div class="row">
          ...
          <div class="box box-primary">
            ...
            <form role="form" method="post" action="<?php echo site_url('admin/Category/editCategory/'.$catinfo[0]->categoryID);?>">
              <div class="box-body">
                <div class="form-group">
                  <label for="exampleInputEmail1">Enter Category Name</label>
                  <input type="text" class="form-control" id="exampleInputEmail1" placeholder="new category" name="txtCat" value="<?php echo $catinfo[0]->categoryName?>">
                </div>                
              </div>
