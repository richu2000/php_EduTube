    ...
    <section class="content">
 		<div class="row">
          ...
          <div class="box box-primary">
            ...
            <form role="form" method="post" action="<?php echo site_url('admin/Country/editstate/'.$stateinfo[0]->stateID.'/'.$stateinfo[0]->countryID);?>">
              <div class="box-body">
                <div class="form-group">
                  <label for="exampleInputEmail1">Enter state Name</label>
                  <input type="text" class="form-control" id="exampleInputEmail1" placeholder="newstate" name="txtstate" value="<?php echo $stateinfo[0]->stateName?>">
                </div>                
              </div>
