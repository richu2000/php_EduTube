    ...
    <section class="content">
 		<div class="row">
          ...
          <div class="box box-primary">
            ...
            <form role="form" method="post" action="<?php echo site_url('admin/Category/editSubcategory/'.$subcatinfo[0]->SubCatID.'/'.$subcatinfo[0]->CategoryID);?>">
              <div class="box-body">
                <div class="form-group">
                  <label for="exampleInputEmail1">Enter sub Category Name</label>
                  <input type="text" class="form-control" id="exampleInputEmail1" placeholder="new sub category" name="txtsubcat" value="<?php echo $subcatinfo[0]->SubCatName?>">
                </div>                
              </div>
